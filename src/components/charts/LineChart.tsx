import { CartesianGrid, Legend, Line, LineChart as LineChartRecharts, ResponsiveContainer, Tooltip, XAxis, YAxis } from 'recharts';
...
export const LineChart = ({ data, keysDescription, showLegend = true, showAxisDescription = true, xAxisLabel, yAxisLabel, selectedKeys }: LineChartProps) => {
                ...
                >
                    ...
                    {showLegend && <Legend content={renderLegend} />}
                    {
                        Object.entries(filteredKeysDescription).map(([key, description]) => (
                            <Line key={key} dataKey={key} stroke={description.color} strokeWidth={2} dot={{ r: 4 }} />
                        ))
                    }
                </LineChartRecharts>
            </ResponsiveContainer>
